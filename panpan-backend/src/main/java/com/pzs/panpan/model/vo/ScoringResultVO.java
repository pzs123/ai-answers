...
public class ScoringResultVO implements Serializable {
    ...
    public static ScoringResult voToObj(ScoringResultVO scoringResultVO) {
        ...
        List<String> list = scoringResultVO.getResultProp();
        scoringResult.setResultProp(JSONUtil.toJsonStr(list));// 将list转换为字符串
    ...
    public static ScoringResultVO objToVo(ScoringResult scoringResult) {
        ...
        scoringResultVO.setResultProp(JSONUtil.toList(scoringResult.getResultProp(), String.class)); // 将字符串转换为list
